...
def csv_line(layer_class_name, layer_name, config) :
    ...
    data['output_shape'] = []
    data['Params'] = 0 # Nb of parametrs (0 for initialization only, cuz we'll get the information later)
...
if __name__ == "__main__" :
    ...
    # My idea was to generate first a json file which parse the CNN architecture descriptor, 
    ...
    input_path = "./Generated_Models/json_files/"+model_name+".json"
    output_path = "./Generated_Models/csv_files/"+model_name+".csv"
    ...
    #4 create a json object of conv layers with the available parametrs from the model descriptor
