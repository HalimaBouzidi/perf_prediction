...
if __name__ == "__main__" :
    ...
    if(model_name == 'DenseNet-121' or model_name == 'DenseNet-161' or model_name == 'DenseNet-169' or model_name == 'DenseNet-201' or model_name == 'DenseNet-264') :
        ...
        from resnet_cifare_10 import resnet_v1
        model= resnet_v1(input_shape=(image_size, image_size, 3), depth=1001, num_classes=10)
    ...
    with open("./Models/"+model_name+"/Saved-Model/json_files/"+model_name+"_"+args.image_size+".json", "w") as json_file:
